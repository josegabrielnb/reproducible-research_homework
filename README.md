...
-($Log\beta$)=1.5152  $\beta$= 1181.8     (P-value = 2.28e-10)

-($\alpha$)=7.0748     (P-value = 6.44e-10)

Both of these values are statistically significant as can be seen from the p values generated by the model. 
